    ...
    <div class="container">
      ...
      <section class="main">
        <article class="main-content">
          ...
          <hr class="line">
          <div class="main-text">
            <p>Perceptive Investigations offers complete investigations that include:</p>
            <br>
            <ul class="services-list">
              <li>Marital, Custody and Child Abuse</li>
              <li>Caretaker and Elder Abuse</li>
              <li>Fraud and Finacial Crimes</li>
          ...
          <!-- <br>
          Caretaker and Elder Abuse
          <br>
          Fraud and Finacial Crimes
          <br>
